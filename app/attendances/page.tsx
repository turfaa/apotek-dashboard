...
export default function AttendancesPage(): React.ReactElement {
    ...
    const attendanceTypesPromise = sessionPromise.then((session) =>
        ...
        <main className="p-4 md:p-10 mx-auto max-w-7xl">
            ...
            <div className="mb-4 p-4 bg-muted/30 rounded-lg">
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                    <li>
                        • Klik pada sel yang dapat diedit (bulan ini, bulan
                        lalu, atau bulan depan) untuk mengubah kehadiran
                    </li>
                    <li>
                        • Sel yang tidak dapat diedit akan terlihat redup dan
                        tidak dapat diklik
                    </li>
                    <li>
                        • Baris total di bawah menunjukkan jumlah hari kerja dan
                        total jam lembur per karyawan
                    </li>
                    <li>
                        • Gunakan pemilih bulan di atas untuk beralih antar
                        bulan
                    </li>
                </ul>
            </div>
