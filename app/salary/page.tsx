...
export default async function SalaryPage({ searchParams }: SalaryPageProps): Promise<React.ReactElement> {
    ...
    return (
        <main className="p-4 md:p-10 mx-auto max-w-7xl">
            <div className="mb-6">
                <Title>Gaji</Title>
                <Subtitle>Lihat detail gaji karyawan per bulan di sini.</Subtitle>
            </div>
