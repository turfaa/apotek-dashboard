...
## [v0.21.2] - 2024-11-15
### :bug: Bug Fixes
- [`712fa00`](https://github.com/turfaa/apotek-dashboard/commit/712fa00993c151ac4dd4410920502294b2caa93b) - Copy public files


## [v0.21.1] - 2024-11-15
### :bug: Bug Fixes
- [`712fa00`](https://github.com/turfaa/apotek-dashboard/commit/712fa0053f5f42bf22dc935cf3542bc064852a1a) - try to resolve issue with node 22
...
- [`712fa00`](https://github.com/turfaa/apotek-dashboard/commit/712fa00b282db9b000377f9eaebe0b0b4c1be24c) - Auto-update drugs every 10 seconds in price list page *(commit by [@turfaa](https://github.com/turfaa))*


## [v0.20.1] - 2024-11-13
### :bug: Bug Fixes
- [`712fa00`](https://github.com/turfaa/apotek-dashboard/commit/712fa0076a4b7431939b4946bd24be3d90bb4eb8) - Use printer icon for printing *(commit by [@turfaa](https://github.com/turfaa))*
...
## [v0.17.11] - 2024-10-16
### :bug: Bug Fixes
- [`64c8e3e`](https://github.com/turfaa/apotek-dashboard/commit/64c8e3ec4788377293830bddddbabd2e7197660d) - fix trigger-deployment workflow *(commit by [@turfaa](https://github.com/turfaa))*


## [v0.17.10] - 2024-10-16
### :bug: Bug Fixes
- [`9cbcf89`](https://github.com/turfaa/apotek-dashboard/commit/9cbcf8960eb16f2e4b6a456759493e41da14c4cf) - fix trigger-deployment workflow *(commit by [@turfaa](https://github.com/turfaa))*


## [v0.17.9] - 2024-10-16
### :bug: Bug Fixes
- [`7af812a`](https://github.com/turfaa/apotek-dashboard/commit/7af812ad1a7e3508662d7c2a024de2f69d1299e6) - deploy latest tag *(commit by [@turfaa](https://github.com/turfaa))*


## [v0.17.8] - 2024-10-16
### :bug: Bug Fixes
- [`56a0c4a`](https://github.com/turfaa/apotek-dashboard/commit/56a0c4ae6742354266fc813bc56b1cbf1b043f5c) - fix trigger-deployment workflow *(commit by [@turfaa](https://github.com/turfaa))*
...
- [`ec5f7d7`](https://github.com/turfaa/apotek-dashboard/commit/ec5f7d78953d4aba70fafc115db587bb02bf7682) - test adding deployment trigger *(commit by [@turfaa](https://github.com/turfaa))*
...
## [v0.16.1] - 2024-10-01
### :bug: Bug Fixes
- [`01bcb91`](https://github.com/turfaa/apotek-dashboard/commit/01bcb9161005e7762adcbae9de23be1958d678d5) - **middleware**: add request header when rewriting the url *(commit by [@turfaa](https://github.com/turfaa))*
...
## [v0.14.4] - 2024-04-17
### :bug: Bug Fixes
- [`730584a`](https://github.com/turfaa/apotek-dashboard/commit/730584a3d4b8adb9f9385d52b10a36c90d521453) - use only alphanumeric chars in term-frequency lib *(commit by [@turfaa](https://github.com/turfaa))*
...
### :wrench: Chores
- [`be7034b`](https://github.com/turfaa/apotek-dashboard/commit/be7034b93b6d52ccef752a91828b8553b04b703f) - add sonar again *(commit by [@turfaa](https://github.com/turfaa))*
...
## [v0.13.0] - 2024-03-07
### :sparkles: New Features
- [`92b1dec`](https://github.com/turfaa/apotek-dashboard/commit/92b1dec7d743ff4bb4de490b873b24c6fbc38ec0) - Change stock opname 'summary' to 'compacted' to prepare for new 'summary' *(commit by [@turfaa](https://github.com/turfaa))*

### :wrench: Chores
- [`5516ac8`](https://github.com/turfaa/apotek-dashboard/commit/5516ac8bc61221c49bbab0c44eb2c54e01b0023c) - Remove unused getDailySalesStatistics *(commit by [@turfaa](https://github.com/turfaa))*
...
## [v0.12.0] - 2024-01-23
### :sparkles: New Features
- [`c87f2ad`](https://github.com/turfaa/apotek-dashboard/commit/c87f2ad5de4b2ca5283e4d5437c22d3c1a08b610) - Show drug stocks *(commit by [@turfaa](https://github.com/turfaa))*


## [v0.11.1] - 2024-01-06
### :bug: Bug Fixes
- [`23c1181`](https://github.com/turfaa/apotek-dashboard/commit/23c11816706cc7513ca457ce44fd2af7253e8c7f) - do not show manufacturer in drugs-to-stock-opname *(commit by [@turfaa](https://github.com/turfaa))*
...
[v0.17.8]: https://github.com/turfaa/apotek-dashboard/compare/v0.17.7...v0.17.8
[v0.17.9]: https://github.com/turfaa/apotek-dashboard/compare/v0.17.8...v0.17.9
